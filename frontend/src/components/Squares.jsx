...
const Squares = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Creates a radial gradient fade-out matching the ApexNova background (#060608)
      ...
      gradient.addColorStop(1, 'rgba(6, 6, 8, 1)'); // Matched to #060608
  ...
  // Make sure it doesn't intercept all clicks on the page if we place it globally, but we want hover
  // The animated background is usually pointerEvents: none. We'll set pointerEvents: auto on just the canvas so hover works.
  return (
    <canvas 
      ref={canvasRef} 
      style={{

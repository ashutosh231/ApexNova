...
import { SESSION_GAME_KEY } from '../data/tournamentConfig.js';
...
const LobbyPage = () => {
  ...
  const activeGame = () => {
    try {
      return sessionStorage.getItem(SESSION_GAME_KEY) || 'snake';
    } catch {
      return 'snake';
    }
  };
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#060608', position:'relative', overflow:'hidden', fontFamily:"'Space Grotesk', sans-serif" }}>
      ...
      <main style={{ maxWidth:1240, margin:'0 auto', padding:'24px 24px 80px', position:'relative', zIndex:1 }}>
        ...
        <motion.header initial={{ opacity: 0, y: -14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: LIME, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Snake Championship</span>
              ...
              <motion.div variants={fadeUp}
                ...
                <div style={{ padding: '28px 32px 32px' }}>
                  ...
                  <h1 style={{ margin: '0 0 10px', color: '#fff', fontSize: 38, fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.1 }}>
                    {game?.title || 'Snake Championship'}
                  </h1>
                  <p style={{ margin: '0 0 28px', color: 'rgba(255,255,255,0.5)', fontSize: 14, lineHeight: 1.6, maxWidth: 440 }}>
                    Competitive season is live. Queue in, outmanoeuvre opponents, and climb the global rankings in real-time matches.
                  </p>
                  ...
                  <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: '#000',
                        background: addSubmitting || !addTag.trim() ? 'rgba(204,255,0,0.35)' : LIME,
                        padding: '9px 14px',
      ...
      <style>{`
        @keyframes pulse { 0%,100%{opacity:1;box-shadow:0 0 10px #ccff00} 50%{opacity:0.6;box-shadow:0 0 20px #ccff00} }
